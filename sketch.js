...
var leftKeyActiveP1 = false
var leftKeyActiveP2 = false
...
function setup() 
{
  ...
  wall2 = createSprite(-80,250,2,500)
  wall2.visible = false;
  wallGroup.add(wall2)
...
function draw() 
{
  ...
  if(GameState == 1){
    ...
    //PLAYER1 CONTROLS :-
    if(keyDown("A")){
      leftKeyActiveP1 = false;
      player1.x= player1.x-8;
    }

    if(keyDown("S")){
      leftKeyActiveP1 = true;
      player1.x= player1.x+8;
    }
    ...
    //PLAYER2 CONTROLS :-
    if(keyDown("L")){
      leftKeyActiveP2 = false
      player2.x= player2.x+8;
    }
    if(keyDown("K")){
      leftKeyActiveP2 = true
      player2.x= player2.x-8;
    }
